    ...
    if(curr.flag == 0 and stage < 5 and stage > 0):
        ...
        #목적지 순서당 가지는 Goal 값
            if i == 1:
                c_x -= 0.5
                c_y += 0.5
                hh_stage.stage_goal = [c_x, c_y, 0.0275308207950712, 0.9996209551156626]
            elif i == 2:
                c_x -= 0.5
                c_y += 0.5
                hh_stage.stage_goal = [c_x, c_y, 0.0275308207950712, 0.9996209551156626]
                ...
                c_x += 0.5
                c_y += 0.5
                hh_stage.stage_goal = [c_x, c_y, -0.701064757180188, 0.7130976134021794]
            elif i == 4:
                c_x += 0.5
                c_y += 0.5
                hh_stage.stage_goal = [c_x, c_y, -0.701064757180188, 0.7130976134021794]
                ...
                c_x += 0.5
                c_y -= 0.5
                hh_stage.stage_goal = [c_x, c_y, 0.9997869287052928, 0.02064212174263571]
            elif i == 6:
                c_x += 0.5
                c_y -= 0.5
                hh_stage.stage_goal = [c_x, c_y, 0.9997869287052928, 0.02064212174263571]
