...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/captain/catkin_ws/src/git_hairD/git_yolov/src/yolov5/runs/train/QR_result3/weights/best.pt', help='model path or triton URL')
